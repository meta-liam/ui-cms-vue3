<template>
  <div class="liam_container">
    ...
    <el-table :data="items" style="width: 100%" height="75vh">
      ...
      <el-table-column fixed prop="symbol" label="代号" width="120" />
...
import ItemEdit from './components/symbol-edit'
import { getItems, addOrEditItem, setAddNew, setEditData, deleteItem } from './symbol'
